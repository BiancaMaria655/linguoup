...
- Name: onboarding.spec.ts >> CHG-012 — Auth & Onboarding E2E >> Authenticated user with completed onboarding goes to dashboard
- Location: tests/e2e/onboarding.spec.ts:269:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/welcome
Call log:
  - navigating to "http://localhost:3001/welcome", waiting until "load"
