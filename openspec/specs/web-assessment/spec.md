...
Especificação do fluxo de avaliação de nível inicial no portal web: questionário de múltipla escolha, feedback por questão e exibição de resultado com nível detectado.
