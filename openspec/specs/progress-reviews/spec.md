...
Define os requisitos para as telas de progresso e revisão espaçada da área autenticada, incluindo os hooks de encapsulamento de lógica (`useStreakScreen`, `useReviewSession`), as páginas `/progress`, `/reviews` e `/profile`, além de testes unitários e E2E que cobrem as jornadas principais.
