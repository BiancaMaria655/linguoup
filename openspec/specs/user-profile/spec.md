...
Define os requisitos para a tela de perfil do usuário, incluindo o hook `useProfileScreen` que encapsula a busca de perfil, XP, conquistas, além da funcionalidade de edição do nome e o fluxo de logout.
