...
Define a infraestrutura local de desenvolvimento via Docker Compose e a documentação de variáveis de ambiente. Garante que qualquer desenvolvedor consiga subir PostgreSQL 15, Redis 7 e pgAdmin com um único comando, e que nenhum segredo seja versionado.
