...
Especificação do fluxo de onboarding multi-step para novos usuários no portal web: coleta de objetivo, idioma, disponibilidade e plano antes de iniciar a avaliação.
