...
Defines the requirements for the `GET /api/v1/streak` endpoint, which returns the authenticated user's current streak, longest streak, and a 30-day activity calendar scoped to their `tenant_id`.
