...
Define the API authentication and authorization mechanisms for LinguoUp, including user registration, secure login, Token Refresh Rotation (RTR), logout, and endpoint protection via Role-Based Access Control (RBAC).
