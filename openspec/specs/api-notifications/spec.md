# api-notifications Spec

## Purpose

Specifies the notification system for the LinguoUp platform. Covers retrieving user notification history, marking notifications as read, triggering admin test notifications, and the daily study reminder scheduler.
