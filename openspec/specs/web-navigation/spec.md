...
Especificação do roteamento e navegação do portal web: splash screen, redirecionamentos condicionais por estado de autenticação/onboarding, e separação de responsabilidades entre UI e lógica via hooks customizados.
